...
func (c *jobClient) AddJob(ctx context.Context, in *AddJobRequest, opts ...grpc.CallOption) (*AddJobResponse, error) {
	out := new(AddJobResponse)
	err := c.cc.Invoke(ctx, "/pkg.manager.http.grpc.Job/AddJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Job_AddJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobServer).AddJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pkg.manager.http.grpc.Job/AddJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServer).AddJob(ctx, req.(*AddJobRequest))
	}
...
var Job_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pkg.manager.http.grpc.Job",
	...
	Metadata: "pkg/manager/http/grpc/job.proto",
}
